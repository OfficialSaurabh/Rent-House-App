            ...
            <div className=" mb-10 justify-between rounded-md border bg-white p-5 pb-10 shadow-md">
              <div className="px-5">
                ...
                <p className="text-xs sm:text-sm md:text-base">
                  Rent House is used by millions of renters to find
                  houses,rooms,condos,or,atartments for rent.
                </p>
              </div>
              <hr className="my-6 border-gray-700  sm:mx-auto lg:my-8" />
              <div className="flex px-5 flex-col-reverse sm:flex-row md:flex-row lg:flex-row">
                <div className="">
                  <div className="flex items-start gap-x-5 ">
                    ...
                    <div className="">
                      ...
                      <p className="text-xs sm:text-sm md:text-base">
                        ...
                        with Rent House's screening service.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-x-5">
                    ...
                    <div className="">
                      ...
                      <p className="text-xs sm:text-sm md:text-base">
                        ...
                        notifications with a new listing is posted.
                      </p>
                    </div>
                  </div>
                </div>
